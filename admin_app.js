/* ================================================================
   admin-app.js — Attendify Admin Dashboard
   ================================================================ */
...
function toggleDark() {
  ...
  localStorage.setItem('attendify-admin-dark', document.body.classList.contains('dark'));
}

// Apply saved dark mode preference on load
if (localStorage.getItem('attendify-admin-dark') === 'true') {
